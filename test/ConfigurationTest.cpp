...
BOOST_AUTO_TEST_CASE(standard_values)
{
    ...
    Configuration::initialize("/home/IBT/stratmann/MooViE/testfiles/input.csv");
...
{
	Configuration::initialize("/home/IBT/stratmann/MooViE/testfiles/input.csv", "/home/IBT/stratmann/MooViE/testfiles/moovie.conf");
    Configuration& c = Configuration::get_instance();
    ...
    BOOST_CHECK_EQUAL(c.get_num_histogram_classes(), 10);
    BOOST_CHECK_EQUAL(c.get_histogram_height(), 20);
    BOOST_CHECK_EQUAL(c.get_histogram_background(), Color(0,0,0));
    BOOST_CHECK_EQUAL(c.get_histogram_fill(), Color(0.5,0.5,0.5));
