...
{
	DefDataSet set("/home/IBT/stratmann/MooViE/test/files/input.csv");
...
{
	DefDataSet set("/home/IBT/stratmann/MooViE/test/files/input4_nouse.csv");
	...
	BOOST_CHECK_CLOSE(set[0][0].value, 1, eps); BOOST_CHECK(not set[0][0].null);
...
BOOST_AUTO_TEST_CASE(invalid_column_count)
{
	BOOST_CHECK_THROW(
			DefDataSet(
					"/home/IBT/stratmann/MooViE/test/files/input5_nouse.csv"),
			std::length_error);
}
...
BOOST_AUTO_TEST_CASE(invalid_comment)
{
	BOOST_CHECK_THROW(
			DefDataSet(
					"/home/IBT/stratmann/MooViE/test/files/input6_nouse.csv"),
			std::length_error);
}
