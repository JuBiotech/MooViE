...
public:
  ...
  static const double DATA_LINK_LINE_WIDTH, CONNECTOR_ARROW_HEIGHT;

  static const double RADIUS_HISTOGRAM_DELTA, CONNECTOR_DELTA, TEXT_DELTA,
	  ANGLE_DELTA_SMALL, ANGLE_DELTA_MEDIUM, ANGLE_DELTA_LARGE,
	  RADIUS_DELTA, OUTPUT_EXTREME_RADIUS_DELTA,
	  OUTPUT_LABEL_LINE_END_DELTA, OUTPUT_LABEL_FONT_FACTOR,
	  INPUT_AXIS_FONT_FACTOR, INPUT_TICK_FONT_FACTOR;
