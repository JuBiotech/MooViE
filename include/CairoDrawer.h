...
public:
  ...
  static const double RADIUS_LABEL_DELTA, RADIUS_HISTOGRAM_DELTA,
      CONNECTOR_DELTA, TEXT_DELTA, ANGLE_DELTA_SMALL, ANGLE_DELTA_MEDIUM,
      ANGLE_DELTA_LARGE, RADIUS_DELTA, OUTPUT_EXTREME_RADIUS_DELTA,
      OUTPUT_LABEL_LINE_END_DELTA, OUTPUT_LABEL_RADIUS_DELTA;
